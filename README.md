...
3. **Configuration**: 
   ...
   - Download [configuration.yml.example](https://raw.githubusercontent.com/DerOetzi/solaredge2mqtt/master/configuration.yml.example) and save as `config/configuration.yml`
   - Download [secrets.yml.example](https://raw.githubusercontent.com/DerOetzi/solaredge2mqtt/master/secrets.yml.example) and save as `config/secrets.yml`
...
1. **Configuration**: Download the example files:
   ...
   - [configuration.yml.example](https://raw.githubusercontent.com/DerOetzi/solaredge2mqtt/master/configuration.yml.example)
   - [secrets.yml.example](https://raw.githubusercontent.com/DerOetzi/solaredge2mqtt/master/secrets.yml.example)
