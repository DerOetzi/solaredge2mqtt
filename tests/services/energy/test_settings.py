...
class TestPriceSettings:
    ...
    def test_price_settings_custom_values(self):
        ...
        assert settings.consumption == 0.30
        assert settings.delivery == 0.08
